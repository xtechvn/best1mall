...
namespace Best1Mall_Front_End.Utilities
{
    public static class LoggerDiscord
    {
        ...
        private static readonly string WebhookUrl = "https://discord.com/api/webhooks/1389903605351452713/dBi5MlRfhZhi_i_U9w6ldC45XOzAHdSNKKm0hfAsi1gm_KFT8iF3BMZDam8RQAMycleU";

        // Sử dụng HttpClient duy nhất để tối ưu hiệu suất
        private static readonly HttpClient _httpClient = new HttpClient();

        public static void Sendlog(string simpleLog)
        {
            try
            {
        ...
        public static async Task SendSimpleMessageAsync(string message)
        {
            ...
            {
                content = message,
                username = "Log Bestmall Live", // Tên hiển thị trên Discord
