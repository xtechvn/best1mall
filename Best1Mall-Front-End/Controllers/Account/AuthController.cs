    ...
    public async Task<IActionResult> GoogleSignInCallback(string code)
    {
        ...
        try
        {
           ...
           // HttpContext.Response.Headers.Add("Cross-Origin-Opener-Policy", "same-origin");
            ...
            LogHelper.InsertLogTelegramByUrl(_configuration["BotSetting:bot_token"], _configuration["BotSetting:bot_group_id"], "GoogleSignInCallback - Authentication:" + fullDomain+"\nCode: "+code);
