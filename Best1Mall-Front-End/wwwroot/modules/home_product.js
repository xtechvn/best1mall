$(document).ready(function () {
    ...
    let group_id = parseInt($(".category_id").data("categoryid")) || 0;
...
var home_product = {
    ...
    loadListProduct: function (group_id, skip, take, view_name) {
        debugger
    ...
    loadMore: function () {
        ...
        // Gọi lại function loadListProduct để tải thêm sản phẩm
